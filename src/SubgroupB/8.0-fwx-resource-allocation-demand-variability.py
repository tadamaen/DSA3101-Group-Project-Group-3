...
df = pd.read_csv("/app/data/processed/waittime_cleandata.csv")
...
Rationale for 9000 visitors, an average of the total annumal visitors, is mentioned in Subgroup B question 2.
"""
